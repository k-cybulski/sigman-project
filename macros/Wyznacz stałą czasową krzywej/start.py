...
class dialogBox (QW.QDialog):
    ...
    def __init__(self, compositeDataWrapper):
        ...
        self.title = "Wyznacz stałą czasową"
        self.setWindowTitle(self.title)
        gridLayout = QW.QGridLayout()
        
        self.setLayout(gridLayout)
      
        self.valueLabel = QW.QLabel("Wybierz sygnał do analizy")
        ...
        self.timeLabel = QW.QLabel("Punkty wyznaczające początek wyrzutu:")
        ...
        self.PercentLabel = QW.QLabel("Analizowane procenty cyklu [licząc od końca]:")
        ...
        self.WzLabel = QW.QLabel("Współczynnik zbierzności")
