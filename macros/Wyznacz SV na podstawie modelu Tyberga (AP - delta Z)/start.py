...
class dialogBox (QW.QDialog):
    ...
    def __init__(self, compositeDataWrapper):
        ...
        self.title = "Wyznacz SV na podstawie modelu Tyberga"
        self.setWindowTitle(self.title)
        gridLayout = QW.QGridLayout()
        
        self.setLayout(gridLayout)
      
        self.valueLabel = QW.QLabel("Wybierz sygnał ciśnienia (AP):")
        ...
        self.startAPLabel = QW.QLabel("Punkty określające początek wyrzutu w sygnale ciśnieniowym:")
        ...
        self.volumeLabel = QW.QLabel("Wybierz sygnał objętościowy (delta Z):")
        ...
        self.startVLabel = QW.QLabel("Punkty określające początek wyrzutu w sygnale objętościowym:")
        ...
        self.minMax = QW.QCheckBox('Dopasuj na podstawie minimum i końca wyrzutu', self)
        self.minMax.toggle()
        gridLayout.addWidget(self.minMax,9,1)
        
        self.linearRegresion = QW.QCheckBox('Dopasuj krzywe z wykorzystaniem liniowej regresji', self)
        self.linearRegresion.toggle()
        gridLayout.addWidget(self.linearRegresion,10,1)

        self.baseOnC = QW.QCheckBox('Dopasuj krzywe bazując na podatności', self)
        self.baseOnC.toggle()
