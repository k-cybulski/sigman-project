...
description = (
"""Procedure detect point B in ICG signal as 15% of the dz/dtmax value (ICG is corrected  by mean value of the signal in cardiac cycle)
""")
author = 'mzylinski'
arguments = {
    }
...
def procedure(waves, points, begin_time, end_time, settings):
    ...
    for i in range(0,len(R)-1):
        ...
        prog = (data_max-mean.data_y[i])*0.15
        while data[itemindex[0]]>prog:
