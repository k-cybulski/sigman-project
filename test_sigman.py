...
data_waves={'bp':bp_line, 'ecg':ecg_line}
data_points={'r':r_points}
complete_data = sm.Composite_data(data_waves = data_waves, data_points = data_points)
...
complete_data.data_waves['bp'].offset = -0.2
...
complete_data.data_waves['bp'].offset = 0
...
complete_data.add_data_points(found_points, 'r', join=True)
...
complete_data.add_data_points(found_points, 'r')
...
x = 241.227
y = complete_data.data_waves['ecg'].value_at(x)
...
complete_data.add_data_points(found_sbp, 'sbp')
...
complete_data.add_data_points(found_dbp, 'dbp')
...
complete_data.add_data_points(found_dn, 'dn')
